<template lang="pug" >
  div.main-container
    ...
    header-component
    .main
      article-component(v-if="activePost", :postInfo = " {origin: activePost.article.origin, redaction: activePost.article.redaction, translate: activePost.article.translate, infographic: activePost.article.infographic, tags: activePost.article.tags} ",
